                ...
                >
                    ...
                    <div v-if="!user" class="mt-6 flex flex-col gap-3">
                        ...
                        >
                            <!-- Google G -->
                            <svg class="h-4 w-4 shrink-0" viewBox="0 0 24 24" fill="currentColor">
                                <path d="M21.805 10.023H12v3.955h5.618c-.242 1.285-.976 2.373-2.078 3.103v2.58h3.362c1.966-1.81 3.1-4.476 3.1-7.647 0-.744-.067-1.462-.197-2.156-.001.001-.001.165 0 .165z" opacity=".9"/>
                                <path d="M12 22c2.7 0 4.963-.895 6.617-2.42l-3.362-2.579c-.896.6-2.04.953-3.255.953-2.504 0-4.625-1.69-5.382-3.963H3.15v2.661C4.793 19.89 8.157 22 12 22z" opacity=".9"/>
                                <path d="M6.618 13.991A5.98 5.98 0 0 1 6.25 12c0-.692.12-1.365.368-1.991V7.348H3.15A9.98 9.98 0 0 0 2 12c0 1.613.387 3.138 1.15 4.652l3.468-2.661z" opacity=".9"/>
                                <path d="M12 6.046c1.41 0 2.676.485 3.674 1.437l2.754-2.754C16.956 3.198 14.692 2 12 2 8.157 2 4.793 4.11 3.15 7.348l3.468 2.661C7.375 7.736 9.496 6.046 12 6.046z" opacity=".9"/>
                            </svg>
                            Google
                        </a>
                    </div>
