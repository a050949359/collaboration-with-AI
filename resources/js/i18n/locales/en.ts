export default {
    ...
    auth: {
        ...
        twofa_hint: 'Enter the 6-digit code from your authenticator app.',
        twofa_hint_recovery: 'Enter one of your recovery codes (XXXXX-XXXXX).',
        twofa_label_code: 'Verification code',
        twofa_label_recovery: 'Recovery code',
        twofa_use_recovery: 'Use a recovery code',
        twofa_use_totp: 'Use authenticator code',
        twofa_verify: 'Verify',
        twofa_verifying: 'Verifying...',
        twofa_back: '← Back to sign in',
        twofa_failed: 'Verification failed, please try again later',
    ...
    story_relay: {
        ...
        btn_generate_image: '🎨 Generate Portrait',
        btn_img_generating: 'Generating…',
        label_character_image: 'Character Portrait',
