        ...
        <form class="space-y-8" @submit.prevent="submit">
            ...
            <div class="space-y-2">
                <div class="flex items-center justify-between gap-4">
                    ...
                    <Link class="binary-label text-[10px] uppercase text-[var(--binary-outline)] transition hover:text-[var(--binary-primary)]" :href="routes.forgotPassword()">
                        忘記密碼
                    </Link>
                </div>
                <div class="relative">
                    ...
                    >
                    <button type="button" class="absolute inset-y-0 right-3 flex items-center text-[var(--binary-outline)] hover:text-[var(--binary-text)] transition-colors" @click="showPassword = !showPassword">
