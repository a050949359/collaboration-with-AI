        ...
        <main class="pt-24 pb-24">
            <section class="mx-auto max-w-screen-xl px-6 py-12 md:px-8">
                ...
                <div class="binary-card-raised mb-6 rounded-2xl">
                    <div class="flex flex-wrap items-end justify-between gap-4">
                        <div>
                            ...
                            <p class="mt-1 text-sm text-[var(--binary-text-muted)]">{{ t('tour_playground.subtitle') }}</p>
                        </div>
                        ...
                        <div class="flex gap-3">
                            ...
                            <template v-else-if="stats">
                                <div
                                    v-for="card in [
                                        { label: t('tour_playground.stat_passengers'), value: stats.passengers_count },
                                        { label: t('tour_playground.stat_bookings'),   value: stats.bookings_count },
                                        { label: t('tour_playground.stat_tours'),      value: stats.tours_count },
                                    ]"
                                    :key="card.label"
                ...
                <div class="mb-6 flex gap-1 border-b border-[var(--binary-outline)]/20 pb-0">
                    <button
                        v-for="tab in [
                            { key: 'passengers', label: t('tour_playground.tab_passengers') },
                            { key: 'booking',    label: t('tour_playground.tab_booking') },
                            { key: 'management', label: t('tour_playground.tab_management') },
                        ]"
                        :key="tab.key"
                ...
                <div v-show="activeTab === 'booking'">
                    <BookingTab :active="activeTab === 'booking'" @stats-reload="loadStats" />
                </div>
