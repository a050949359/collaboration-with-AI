...
const featuredProjects = [
    {
        ...
        commits: [
            { hash: '252a05d', date: '2026-05-26', message: 'feat(home+bg): canvas matrix rain with arc parallax, add projects 09/10', tag: 'HEAD' },
            { hash: '128957e', date: '2026-05-25', message: 'feat(mcp+tasks): add MCP JSON-RPC endpoint and Task CRUD' },
            { hash: '79e4cff', date: '2026-05-23', message: 'feat(lab): add Computer Vision page with edge detection (WASM)' },
            { hash: '1330a7e', date: '2026-04-29', message: 'ci: 調整 CI/CD workflow，deploy 改為本地 shell 指令' },
