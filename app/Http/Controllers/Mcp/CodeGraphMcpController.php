...
use App\Services\Mcp\CodeGraphMcpService;
use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;

class CodeGraphMcpController extends Controller
{
    public function __construct(private CodeGraphMcpService $service) {}
    ...
    private function initialize(mixed $id): JsonResponse
    {
        return $this->ok($id, [
            ...
            'serverInfo' => ['name' => 'collab-codegraph', 'version' => '1.0.0'],
        ]);
    }
