...
use App\Services\Mcp\RagMcpService;
use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;

class RagMcpController extends Controller
{
    public function __construct(private RagMcpService $service) {}
    ...
    private function initialize(mixed $id): JsonResponse
    {
        return $this->ok($id, [
            ...
            'serverInfo' => ['name' => 'collab-rag', 'version' => '1.0.0'],
        ]);
    }
